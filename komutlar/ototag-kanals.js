...
exports.run = async (client, message, params, args) => {
    ...
    return message.author.send(ozelmesajuyari); }
     ...
     if (!otoTagkanal) return message.channel.send(':no_entry: Otomatik tag komudunun log kanalını ayarlamak için bir kanal etiketlemeniz gerekli. `z!ototag-kanal #kanal`')
